...
<section class="content">
           ...
           <div class="box-body">
              ...
              <?php  $no = 1;
                ...
                <tr>
                  ...
                  <td>
                    <a href="<?php echo base_urL('index.php/smas_controller/edittahun/').$t['id_tahun'];?>"><span class="label label-primary" aria-hidden="true"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Edit</span></a>
                    <a onclick="javascript: return confirm('Are you sure you want to delete this data ?')" href="<?php echo base_urL('index.php/smas_controller/deltahun/').$t['id_tahun'];?>"><span class="label label-danger" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Delete</span></a>
                  </td>
                </tr>
              <?php   } ?>
               </tbody>
   ...
   <div class="modal fade" id="tambah_user" role="dialog">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?php echo base_urL('index.php/smas_controller/addtahun');?>" role="form" method="post">
              <div class="box-body">
